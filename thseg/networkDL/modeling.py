...
def deeplabv3_resnet50(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    model = _load_model('deeplabv3', 'resnet50', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def deeplabv3plus_resnet50(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    model = _load_model('deeplabv3plus', 'resnet50', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
    network.convert_to_separable_conv(model.classifier)
    
    print('Loading modified deeplabv3plus_resnet50...')
...
def deeplabv3plus_mobilenet(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    model = _load_model('deeplabv3plus', 'mobilenetv2', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
    network.convert_to_separable_conv(model.classifier)
    
    print('Loading modified deeplabv3plus_mobilenet...')
