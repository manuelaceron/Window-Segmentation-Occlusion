from networks.deeplab import DeepLabV3Plus, DeepLabV3
from networks.unet import UNet, Res_UNet_50, Res_UNet_34, Res_UNet_101, Res_UNet_152, Dense_UNet_121, AttU_Net, ALKU_Net, BayesianUNet, DeepUNet, Swin_UNet, ASPP_UNet, singleASPP_UNet, new_DeepL
